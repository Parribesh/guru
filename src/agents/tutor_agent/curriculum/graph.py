...
from agents.tutor_agent.curriculum.prompts import build_node_system_prompt
from agents.tutor_agent.curriculum.schemas import MODULE_LEVELS
from agents.tutor_agent.curriculum.stages.concept_generator import MAX_ADD_ROUNDS, MAX_PER_LEVEL, MIN_PER_LEVEL
...
def build_syllabus_level_graph(llm: Any, system_prompt: Optional[str] = None):
    ...
    from agents.tutor_agent.curriculum.stages.add_concepts import add_missing_concepts
    from agents.tutor_agent.curriculum.stages.concept_generator import generate_concepts as run_generator
    from agents.tutor_agent.curriculum.stages.validator import validate_concept_count
