...
exports.updateBrowserViewBounds = updateBrowserViewBounds;
exports.setBrowserViewBounds = setBrowserViewBounds;
/**
 * Updates BrowserView bounds
 */
function updateBrowserViewBounds(view, bounds) {
    view.setBounds(bounds);
}
/**
 * Sets BrowserView bounds based on window size and layout
 */
function setBrowserViewBounds(view, window) {
