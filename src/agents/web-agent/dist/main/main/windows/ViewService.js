"use strict";
// View Service - Creates and manages Electron BrowserView instances
...
function clearAllSessionData(session) {
...
class ViewService {
     ...
     */
    static async createBrowserView(tab, preloadPath, mainWindow) {
            ...
            setTimeout(() => {
                ...
                if (mainWindow && !mainWindow.isDestroyed() && tab && tab.id) {
                    ...
                    if (url && url !== 'about:blank') {
                        ...
                        mainWindow.webContents.send(types_1.IPCChannels.tab.update, update);
    ...
    `)
        ...
        view.webContents.on('did-stop-loading', () => {
            ...
            if (url &&
                ...
                event_logger_1.eventLogger.success('Navigation', `Article fetched: ${title || 'Untitled'}`);
                event_logger_1.eventLogger.info('Navigation', `URL: ${url}`);
            }
        ...
        view.webContents.on('page-favicon-updated', (event, favicons) => {
            ...
            if (favicons.length > 0) {
                view.webContents.send(types_1.IPCChannels.tab.update, {
                    ...tab,
                    favicon: favicons[0],
                });
            }
     ...
     */
    static destroyBrowserView(view) {
        // Clean up resources
