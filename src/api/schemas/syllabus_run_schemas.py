...
class StartSyllabusRunRequest(BaseModel):
    provider: Optional[str] = None  # "gemini" or "ollama"
    model: Optional[str] = None     # e.g. "gemini-3.7-flash", "qwen3:4b"
    agent: Optional[str] = "TutorAgent"


class RerunSyllabusRequest(BaseModel):
