...
from api.routes.tutor_routes import tutor_routes
...
app.include_router(tutor_routes, prefix="/guru")
app.include_router(chat_routes, prefix="/guru")
app.include_router(syllabus_routes, prefix="/guru")
app.include_router(user_routes, prefix="/guru")
app.include_router(admin_routes, prefix="/guru")
